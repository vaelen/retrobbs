...
{
  CRC16 Utility Program

  Calculates CRC-16/KERMIT (CCITT) checksum for files.
  Outputs the result as a hexadecimal number.

  Usage:
    crc16 <filename>    - Calculate CRC16 of file
...
begin
  ...
  begin
    WriteLn(StdErr, 'Usage: crc16 <filename>');
    Halt(1);
  end;
